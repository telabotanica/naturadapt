...
class User implements UserInterface {
    ...
    public function getHasAgreedTou (): bool {
        return $this->hasAgreedTou;
    }

    public function setHasAgreedTou ( ?bool $hasAgreedTou ): self {
        $this->hasAgreedTou = $hasAgreedTou ?? false;
