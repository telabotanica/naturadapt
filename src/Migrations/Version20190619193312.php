...
final class Version20190619193312 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE naturadapt_pages ADD cover_id INT DEFAULT NULL, CHANGE edited_at edited_at DATETIME DEFAULT NULL, CHANGE edition_restricted edition_restricted TINYINT(1) DEFAULT NULL');
        $this->addSql('ALTER TABLE naturadapt_pages ADD CONSTRAINT FK_3F63F727922726E9 FOREIGN KEY (cover_id) REFERENCES naturadapt_files (id)');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_3F63F727922726E9 ON naturadapt_pages (cover_id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE naturadapt_pages DROP FOREIGN KEY FK_3F63F727922726E9');
        $this->addSql('DROP INDEX UNIQ_3F63F727922726E9 ON naturadapt_pages');
        $this->addSql('ALTER TABLE naturadapt_pages DROP cover_id, CHANGE edited_at edited_at DATETIME DEFAULT \'NULL\', CHANGE edition_restricted edition_restricted TINYINT(1) DEFAULT \'NULL\'');
        $this->addSql('ALTER TABLE naturadapt_usergroups CHANGE logo_id logo_id INT DEFAULT NULL, CHANGE cover_id cover_id INT DEFAULT NULL');
