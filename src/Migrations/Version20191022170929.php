...
final class Version20191022170929 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE naturadapt_document_folder (id INT AUTO_INCREMENT NOT NULL, usergroup_id INT NOT NULL, title VARCHAR(100) NOT NULL, INDEX IDX_8AFF503CD2112630 (usergroup_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('ALTER TABLE naturadapt_document_folder ADD CONSTRAINT FK_8AFF503CD2112630 FOREIGN KEY (usergroup_id) REFERENCES naturadapt_usergroups (id)');
        $this->addSql('ALTER TABLE naturadapt_document ADD folder_id INT DEFAULT NULL, CHANGE user_id user_id INT DEFAULT NULL, CHANGE usergroup_id usergroup_id INT DEFAULT NULL, CHANGE file_id file_id INT DEFAULT NULL, CHANGE slug slug VARCHAR(100) DEFAULT NULL, CHANGE title title VARCHAR(100) DEFAULT NULL');
        $this->addSql('ALTER TABLE naturadapt_document ADD CONSTRAINT FK_4C7685A3162CB942 FOREIGN KEY (folder_id) REFERENCES naturadapt_document_folder (id)');
        $this->addSql('CREATE INDEX IDX_4C7685A3162CB942 ON naturadapt_document (folder_id)');
        ...
        $this->addSql('ALTER TABLE naturadapt_files CHANGE user_id user_id INT DEFAULT NULL, CHANGE usergroup_id usergroup_id INT DEFAULT NULL, CHANGE type type VARCHAR(255) DEFAULT NULL, CHANGE size size INT DEFAULT NULL');
        ...
        $this->addSql('ALTER TABLE naturadapt_pages_revisions CHANGE user_id user_id INT DEFAULT NULL, CHANGE data data JSON DEFAULT NULL');
        $this->addSql('ALTER TABLE naturadapt_log_events CHANGE user_id user_id INT DEFAULT NULL, CHANGE usergroup_id usergroup_id INT DEFAULT NULL, CHANGE data data JSON DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE naturadapt_document DROP FOREIGN KEY FK_4C7685A3162CB942');
        $this->addSql('DROP TABLE naturadapt_document_folder');
        $this->addSql('ALTER TABLE naturadapt_articles CHANGE cover_id cover_id INT DEFAULT NULL, CHANGE edited_at edited_at DATETIME DEFAULT \'NULL\'');
        $this->addSql('DROP INDEX IDX_4C7685A3162CB942 ON naturadapt_document');
        $this->addSql('ALTER TABLE naturadapt_document DROP folder_id, CHANGE user_id user_id INT DEFAULT NULL, CHANGE usergroup_id usergroup_id INT DEFAULT NULL, CHANGE file_id file_id INT DEFAULT NULL, CHANGE slug slug VARCHAR(100) DEFAULT \'NULL\' COLLATE utf8mb4_unicode_ci, CHANGE title title VARCHAR(100) DEFAULT \'NULL\' COLLATE utf8mb4_unicode_ci');
        $this->addSql('ALTER TABLE naturadapt_files CHANGE user_id user_id INT DEFAULT NULL, CHANGE usergroup_id usergroup_id INT DEFAULT NULL, CHANGE type type VARCHAR(255) DEFAULT \'NULL\' COLLATE utf8mb4_unicode_ci, CHANGE size size INT DEFAULT NULL');
        $this->addSql('ALTER TABLE naturadapt_log_events CHANGE user_id user_id INT DEFAULT NULL, CHANGE usergroup_id usergroup_id INT DEFAULT NULL, CHANGE data data LONGTEXT DEFAULT NULL COLLATE utf8mb4_bin');
        $this->addSql('ALTER TABLE naturadapt_pages CHANGE cover_id cover_id INT DEFAULT NULL, CHANGE edited_at edited_at DATETIME DEFAULT \'NULL\', CHANGE edition_restricted edition_restricted TINYINT(1) DEFAULT \'NULL\'');
        $this->addSql('ALTER TABLE naturadapt_pages_revisions CHANGE user_id user_id INT DEFAULT NULL, CHANGE data data LONGTEXT DEFAULT NULL COLLATE utf8mb4_bin');
        $this->addSql('ALTER TABLE naturadapt_usergroups CHANGE logo_id logo_id INT DEFAULT NULL, CHANGE cover_id cover_id INT DEFAULT NULL');
