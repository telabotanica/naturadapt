 ...
 */
final class Version20190417125539 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE naturadapt_users (id INT AUTO_INCREMENT NOT NULL, email VARCHAR(180) NOT NULL, roles JSON NOT NULL, password VARCHAR(255) NOT NULL, name VARCHAR(100) DEFAULT NULL, display_name VARCHAR(100) DEFAULT NULL, location VARCHAR(100) DEFAULT NULL, presentation LONGTEXT DEFAULT NULL, avatar VARCHAR(100) DEFAULT NULL, profile_visibility VARCHAR(100) DEFAULT NULL, locale VARCHAR(100) DEFAULT NULL, timezone VARCHAR(100) DEFAULT NULL, created_at DATETIME NOT NULL, seen_at DATETIME DEFAULT NULL, reset_token VARCHAR(255) DEFAULT NULL, status SMALLINT NOT NULL, UNIQUE INDEX UNIQ_B94B7BBE7927C74 (email), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
