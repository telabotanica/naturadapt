...
final class Version20190612145436 extends AbstractMigration {
	public function up ( Schema $schema ): void {
		...
		$this->addSql( 'CREATE TABLE naturadapt_document (id INT AUTO_INCREMENT NOT NULL, user_id INT DEFAULT NULL, usergroup_id INT DEFAULT NULL, file_id INT DEFAULT NULL, INDEX IDX_4C7685A3A76ED395 (user_id), INDEX IDX_4C7685A3D2112630 (usergroup_id), INDEX IDX_4C7685A393CB796C (file_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB' );
		$this->addSql( 'ALTER TABLE naturadapt_document ADD CONSTRAINT FK_4C7685A3A76ED395 FOREIGN KEY (user_id) REFERENCES naturadapt_users (id)' );
		$this->addSql( 'ALTER TABLE naturadapt_document ADD CONSTRAINT FK_4C7685A3D2112630 FOREIGN KEY (usergroup_id) REFERENCES naturadapt_usergroups (id)' );
		$this->addSql( 'ALTER TABLE naturadapt_document ADD CONSTRAINT FK_4C7685A393CB796C FOREIGN KEY (file_id) REFERENCES naturadapt_files (id)' );
	...
	public function down ( Schema $schema ): void {
		...
		$this->addSql( 'DROP TABLE naturadapt_document' );
