...
final class Version20190620174117 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE pollinisateurs_pages_revisions (id INT AUTO_INCREMENT NOT NULL, page_id INT NOT NULL, user_id INT DEFAULT NULL, data JSON DEFAULT NULL, created_at DATETIME NOT NULL, INDEX IDX_9B744781C4663E4 (page_id), INDEX IDX_9B744781A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP TABLE pollinisateurs_pages_revisions');
        $this->addSql('ALTER TABLE pollinisateurs_articles CHANGE cover_id cover_id INT DEFAULT NULL, CHANGE edited_at edited_at DATETIME DEFAULT \'NULL\'');
