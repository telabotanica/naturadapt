 ...
 */
final class Version20190619193312 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE pollinisateurs_document CHANGE user_id user_id INT DEFAULT NULL, CHANGE usergroup_id usergroup_id INT DEFAULT NULL, CHANGE file_id file_id INT DEFAULT NULL, CHANGE slug slug VARCHAR(100) DEFAULT NULL');
        ...
        $this->addSql('ALTER TABLE pollinisateurs_pages ADD cover_id INT DEFAULT NULL, CHANGE edited_at edited_at DATETIME DEFAULT NULL, CHANGE edition_restricted edition_restricted TINYINT(1) DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE pollinisateurs_articles CHANGE cover_id cover_id INT DEFAULT NULL, CHANGE edited_at edited_at DATETIME DEFAULT \'NULL\'');
        $this->addSql('ALTER TABLE pollinisateurs_document CHANGE user_id user_id INT DEFAULT NULL, CHANGE usergroup_id usergroup_id INT DEFAULT NULL, CHANGE file_id file_id INT DEFAULT NULL, CHANGE slug slug VARCHAR(100) DEFAULT \'NULL\' COLLATE utf8mb4_unicode_ci');
        ...
        $this->addSql('ALTER TABLE pollinisateurs_pages DROP cover_id, CHANGE edited_at edited_at DATETIME DEFAULT \'NULL\', CHANGE edition_restricted edition_restricted TINYINT(1) DEFAULT \'NULL\'');
        $this->addSql('ALTER TABLE pollinisateurs_usergroups CHANGE logo_id logo_id INT DEFAULT NULL, CHANGE cover_id cover_id INT DEFAULT NULL');
