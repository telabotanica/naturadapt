 ...
 */
final class Version20190521125057 extends AbstractMigration {
	public function up ( Schema $schema ): void {
		...
		$this->addSql( 'CREATE INDEX status ON pollinisateurs_usergroups_memberships (status)' );
	...
	public function down ( Schema $schema ): void {
		...
		$this->addSql( 'ALTER TABLE pollinisateurs_pages CHANGE edited_at edited_at DATETIME DEFAULT \'NULL\'' );
		$this->addSql( 'DROP INDEX status ON pollinisateurs_usergroups_memberships' );
