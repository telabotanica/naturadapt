...
final class Version20190531170420 extends AbstractMigration {
	public function up ( Schema $schema ): void {
		...
		$this->addSql( 'ALTER TABLE pollinisateurs_pages ADD edition_restricted TINYINT(1) DEFAULT NULL, CHANGE edited_at edited_at DATETIME DEFAULT NULL' );
	}
	...
	public function down ( Schema $schema ): void {
		...
		$this->addSql( 'ALTER TABLE pollinisateurs_pages DROP edition_restricted, CHANGE edited_at edited_at DATETIME DEFAULT \'NULL\'' );
