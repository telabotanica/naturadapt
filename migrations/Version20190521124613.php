...
final class Version20190521124613 extends AbstractMigration {
	public function up ( Schema $schema ): void {
		...
		$this->addSql( 'ALTER TABLE pollinisateurs_usergroups_memberships ADD status VARCHAR(32) DEFAULT NULL, CHANGE role role VARCHAR(255) DEFAULT NULL, CHANGE notifications_settings notifications_settings JSON DEFAULT NULL' );
	...
	public function down ( Schema $schema ): void {
		...
		$this->addSql( 'ALTER TABLE pollinisateurs_pages CHANGE edited_at edited_at DATETIME DEFAULT \'NULL\'' );
		$this->addSql( 'ALTER TABLE pollinisateurs_usergroups_memberships DROP status, CHANGE role role VARCHAR(255) DEFAULT \'NULL\' COLLATE utf8mb4_unicode_ci, CHANGE notifications_settings notifications_settings LONGTEXT DEFAULT NULL COLLATE utf8mb4_bin' );
