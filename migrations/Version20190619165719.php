...
final class Version20190619165719 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE pollinisateurs_articles (id INT AUTO_INCREMENT NOT NULL, usergroup_id INT NOT NULL, author_id INT NOT NULL, cover_id INT DEFAULT NULL, slug VARCHAR(100) NOT NULL, title VARCHAR(100) NOT NULL, body LONGTEXT NOT NULL, created_at DATETIME NOT NULL, edited_at DATETIME DEFAULT NULL, INDEX IDX_2BC23EBDD2112630 (usergroup_id), INDEX IDX_2BC23EBDF675F31B (author_id), UNIQUE INDEX UNIQ_2BC23EBD922726E9 (cover_id), INDEX slug (slug), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP TABLE pollinisateurs_articles');
