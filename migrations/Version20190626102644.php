...
final class Version20190626102644 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE pollinisateurs_pages CHANGE cover_id cover_id INT DEFAULT NULL, CHANGE body body LONGTEXT DEFAULT NULL, CHANGE edited_at edited_at DATETIME DEFAULT NULL, CHANGE edition_restricted edition_restricted TINYINT(1) DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE pollinisateurs_pages CHANGE cover_id cover_id INT DEFAULT NULL, CHANGE body body LONGTEXT NOT NULL COLLATE utf8mb4_unicode_ci, CHANGE edited_at edited_at DATETIME DEFAULT \'NULL\', CHANGE edition_restricted edition_restricted TINYINT(1) DEFAULT \'NULL\'');
